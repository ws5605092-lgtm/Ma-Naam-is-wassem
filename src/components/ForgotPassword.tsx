  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-slate-950 text-slate-100 p-4 font-sans">
      <div className="w-full max-w-md bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl overflow-hidden">
        <div className="bg-gradient-to-r from-rose-500 to-amber-500 h-2 w-full" />
        ...
        <div className="p-8">
          ...
          {success ? (
            ...
            >
              ...
              <button
                onClick={onBack}
                className="w-full bg-slate-800 hover:bg-slate-700 text-white font-medium py-3 rounded-xl transition-all cursor-pointer"
              >
                Go to Calculator
              </button>
            </motion.div>
            ...
            >
              <div>
                <h2 className="text-md font-medium text-slate-300 mb-2 flex items-center gap-1.5">
                  <HelpCircle className="w-4 h-4 text-rose-400" /> Security Challenge
                </h2>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-slate-950 border border-slate-800 rounded-xl">
                  <label className="block text-[10px] uppercase font-bold text-rose-400 tracking-wider mb-1">
                    Your Question
                  </label>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-950 border border-slate-800 rounded-xl px-4 py-3 text-sm text-slate-200 focus:outline-none focus:border-rose-500 transition-colors"
                  />
                </div>
              </div>
              ...
              <div className="flex gap-3 pt-2">
                <button
                  onClick={onBack}
                  className="w-1/3 flex items-center justify-center space-x-1.5 bg-slate-950 hover:bg-slate-800 border border-slate-800 text-slate-400 hover:text-white rounded-xl transition-all cursor-pointer text-sm"
                >
                ...
                <button
                  ...
                  className="flex-1 bg-gradient-to-r from-rose-500 to-amber-500 hover:from-rose-600 hover:to-amber-600 text-white font-medium py-3 px-6 rounded-xl transition-all cursor-pointer text-sm shadow-md"
                >
                  Verify Answer
                </button>
              </div>
            ...
            >
              <div>
                <h2 className="text-md font-medium text-slate-200 mb-2">Set New Master PIN</h2>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="••••"
                    className="w-full bg-slate-950 border border-slate-800 rounded-xl px-4 py-3.5 text-center text-xl tracking-widest text-emerald-400 focus:outline-none focus:border-emerald-500 transition-colors font-mono"
                  />
                </div>
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white font-medium py-3.5 px-6 rounded-xl shadow-lg transition-all cursor-pointer"
              >
                Save New PIN
              </button>
            </motion.div>
