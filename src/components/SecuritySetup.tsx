      ...
      <div className="w-full max-w-md bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="p-8">
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="text-xs font-mono text-slate-500 bg-slate-950 px-2 py-1 rounded-md border border-slate-800">
              Step {step} of 3
            </div>
          </div>
            ...
            >
              <div>
                <h2 className="text-lg font-medium text-white mb-2 flex items-center gap-2">
                  <Lock className="w-5 h-5 text-emerald-400" /> Define Master PIN
                </h2>
                <p className="text-sm text-slate-400 leading-relaxed">
                  This PIN is your secret key to unlock the private vault. You will enter this PIN on the calculator screen and click <strong className="text-slate-200">=</strong> to gain access.
                </p>
              </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="••••"
                    className="w-full bg-slate-950 border border-slate-800 rounded-xl px-4 py-3.5 text-center text-2xl tracking-widest text-emerald-400 focus:outline-none focus:border-emerald-500 transition-colors font-mono"
                  />
                </div>
              ...
              <button
                ...
                className="w-full flex items-center justify-center space-x-2 bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white font-medium py-3.5 px-6 rounded-xl shadow-lg shadow-emerald-500/10 cursor-pointer hover:shadow-emerald-500/20 active:scale-[0.98] transition-all"
              >
                <span>Continue</span>
          ...
          {step === 2 && (
            ...
            >
              <div>
                <h2 className="text-lg font-medium text-white mb-2 flex items-center gap-2">
                  <EyeOff className="w-5 h-5 text-emerald-400" /> Setup Decoy PIN (Optional)
                </h2>
                <p className="text-sm text-slate-400 leading-relaxed">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-950 border border-slate-800 rounded-xl px-4 py-3.5 text-center text-2xl tracking-widest text-amber-400 focus:outline-none focus:border-amber-500 transition-colors font-mono"
                  />
                </div>

                <div className="p-3 bg-amber-500/5 border border-amber-500/10 rounded-lg text-xs text-amber-300 leading-relaxed flex gap-2">
              ...
              <div className="flex gap-3">
                <button
                  onClick={() => setStep(1)}
                  className="w-1/3 bg-slate-950 hover:bg-slate-800 text-slate-400 hover:text-white border border-slate-800 font-medium py-3.5 px-4 rounded-xl transition-all cursor-pointer"
                >
                  Back
                </button>
                <button
                  onClick={handleNextStep2}
                  className="flex-1 flex items-center justify-center space-x-2 bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white font-medium py-3.5 px-6 rounded-xl shadow-lg cursor-pointer active:scale-[0.98] transition-all"
                >
          ...
          {step === 3 && (
            ...
            >
              <div>
                <h2 className="text-lg font-medium text-white mb-2 flex items-center gap-2">
                  <HelpCircle className="w-5 h-5 text-emerald-400" /> Security Question
                </h2>
                <p className="text-sm text-slate-400 leading-relaxed">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-slate-950 border border-slate-800 rounded-xl px-4 py-3.5 text-sm text-slate-200 focus:outline-none focus:border-emerald-500 transition-colors"
                  >
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 flex items-center justify-center space-x-2 bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white font-medium py-3.5 px-6 rounded-xl shadow-lg shadow-emerald-500/10 cursor-pointer hover:shadow-emerald-500/20 active:scale-[0.98] transition-all"
                >
